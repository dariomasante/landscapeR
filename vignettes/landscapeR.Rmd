...
### `rmSingle`
Remove single tones from patches, reducing salt pepper effect. The cells values are assigned randomly from one of the neighbouring cells.
